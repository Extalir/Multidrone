...
# CC Compiler Flags
CCFLAGS=-Wall -pthread -lpigpio -lrt
CXXFLAGS=-Wall -pthread -lpigpio -lrt
...
${OBJECTDIR}/Barometro/BMP085.o: Barometro/BMP085.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Barometro/BMP085.o Barometro/BMP085.cpp

${OBJECTDIR}/CalcularImu.o: CalcularImu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CalcularImu.o CalcularImu.cpp
...
${OBJECTDIR}/Funciones.o: Funciones.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Funciones.o Funciones.cpp
...
${OBJECTDIR}/I2C/I2Cdev.o: I2C/I2Cdev.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/I2C/I2Cdev.o I2C/I2Cdev.cpp

${OBJECTDIR}/MPU/MPU6050.o: MPU/MPU6050.cpp 
	${MKDIR} -p ${OBJECTDIR}/MPU
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MPU/MPU6050.o MPU/MPU6050.cpp

${OBJECTDIR}/Magnometro/HMC5883L.o: Magnometro/HMC5883L.cpp 
	${MKDIR} -p ${OBJECTDIR}/Magnometro
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Magnometro/HMC5883L.o Magnometro/HMC5883L.cpp

${OBJECTDIR}/Motores.o: Motores.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Motores.o Motores.cpp
...
${OBJECTDIR}/Servidor.o: Servidor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Servidor.o Servidor.cpp
